...
namespace Injector
{
	...
	{
		return std::stringstream::read(reinterpret_cast<char*>(values), sizeof(char) * count);
	}
	...
	{
		return std::stringstream::read(reinterpret_cast<char*>(values), sizeof(uint8_t) * count);
	}
	...
	{
		return std::stringstream::read(reinterpret_cast<char*>(values), sizeof(uint16_t) * count);
	}
	...
	{
		return std::stringstream::read(reinterpret_cast<char*>(values), sizeof(uint32_t) * count);
	}
	...
	{
		return std::stringstream::read(reinterpret_cast<char*>(values), sizeof(int32_t) * count);
	}
	...
	{
		return std::stringstream::read(reinterpret_cast<char*>(values), sizeof(uint64_t) * count);
	}
	...
	{
		return std::stringstream::read(reinterpret_cast<char*>(values), sizeof(int64_t) * count);
	}
	...
	{
		return std::stringstream::read(reinterpret_cast<char*>(values), sizeof(float) * count);
	}
	...
	{
		return std::stringstream::read(reinterpret_cast<char*>(values), sizeof(double) * count);
	}
	...
	{
		auto& stream = std::stringstream::read(reinterpret_cast<char*>(&value), sizeof(int16_t));
		value = ByteSwap::swapBigEndian(value);
		return stream;
	}
	...
	{
		auto& stream = std::stringstream::read(reinterpret_cast<char*>(&value), sizeof(int32_t));
		value = ByteSwap::swapBigEndian(value);
		return stream;
	}
	...
	{
		auto& stream = std::stringstream::read(reinterpret_cast<char*>(&value), sizeof(int64_t));
		value = ByteSwap::swapBigEndian(value);
		return stream;
	}
	...
	{
		return std::stringstream::write(reinterpret_cast<const char*>(values), sizeof(char) * count);
	}
	...
	{
		return std::stringstream::write(reinterpret_cast<const char*>(values), sizeof(uint8_t) * count);
	}
	...
	{
		return std::stringstream::write(reinterpret_cast<const char*>(values), sizeof(int8_t) * count);
	}
	...
	{
		return std::stringstream::write(reinterpret_cast<const char*>(values), sizeof(uint16_t) * count);
	}
	...
	{
		return std::stringstream::write(reinterpret_cast<const char*>(values), sizeof(int16_t) * count);
	}
	...
	{
		return std::stringstream::write(reinterpret_cast<const char*>(values), sizeof(uint32_t) * count);
	}
	...
	{
		return std::stringstream::write(reinterpret_cast<const char*>(values), sizeof(int32_t) * count);
	}
	...
	{
		return std::stringstream::write(reinterpret_cast<const char*>(values), sizeof(uint64_t) * count);
	}
	...
	{
		return std::stringstream::write(reinterpret_cast<const char*>(values), sizeof(int64_t) * count);
	}
	...
	{
		return std::stringstream::write(reinterpret_cast<const char*>(values), sizeof(float) * count);
	}
	...
	{
		return std::stringstream::write(reinterpret_cast<const char*>(values), sizeof(double) * count);
	}
